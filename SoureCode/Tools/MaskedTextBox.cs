...
{
	/// <summary>
	/// Die hier implementierte Textbox erlaubt das setzen von Eingabebeschränkungen
	/// wie beispielsweise nur Ziffern
	/// Der Code stammt von : http://www.csharphelp.com/archives/archive163.html
	/// </summary>
...
//		}
		...
		private void MaskDigit(KeyPressEventArgs e)
		{
			...
			{
				e.Handled = true;
				errorProvider1.SetError(this, "Sie können nur Ziffern eingeben");
			}
		}
		private void MaskDecimal(KeyPressEventArgs e)
		{
			...
			{
				e.Handled = true;
				errorProvider1.SetError(this, "Sie können nur Ziffern und ein Komma eingeben");
			}
		}
